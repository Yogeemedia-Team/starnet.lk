...
<head>
    ...
    <meta name="description"
        content="Starnet offers a complete range of outsourced services to telecom operators and broadcasters. ">
    <meta charset="UTF-8" />
    <title>Starnet</title>
...
<body class="active-preloader-ovh">
        ...
        <div class="header-top">
            <div class="container" id="home">
                <div class="pull-left left-contact-info">
                    <p><i class="fas fa-envelope-open"></i><a href="mailto:info@starnet.lk">info@starnet.lk</a></p><!--
                -->
                    <p><i class="zxp-icon-old-telephone-ringing"></i><a href="tel:+94 11 4503 871">+94 70 3033 000</a>
                    <p><i class="zxp-icon-old-telephone-ringing"></i><a href="tel:+94 11 4503 871">+94 11 4503 871</a>
                    </p>
                </div><!-- /.pull-left -->
                <div class="pull-right right-contact-info">
                    <p><i class="fas fa-clock"></i>Mon - Fri : 8:30 AM to 5:00 PM</p><!--
                -->
                    <!-- <p>
            ...
            <div class="container clearfix">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        <img src="img/starnet-logo.jpeg" alt="Awesome Image" />
                    </a>
                </div>
                ...
                <a href="#test-search" class="fas fa-search search-btn popup-with-zoom-anim"></a><a href="#" class="rqa-btn">Request Quote</a>
            </div> -->
            </div>
        </nav>
    </header><!-- /.header -->
    ...
    <div id="minimal-bootstrap-carousel" class="carousel slide carousel-fade slider-home-two" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active slide-1"
                style="background-image: url(img/caravasal1.jpg);background-position: right center;">

                <div class="carousel-caption">
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h2 data-animation="animated fadeInUp">We Are Your Trusted <br /> Service Provider</h2>
                                <br><br>
                                <!-- <p data-animation="animated fadeInDown">An unknown printer took a galley of type and
                                    scrambled it <br /> to make a type specimen book.</p> -->
                                <a href="#about-us" class="banner-btn" data-animation="animated fadeInDown">About Us</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="item slide-2"
                style="background-image: url(img/caravasal2.jpg);background-position: center center;">

                <div class="carousel-caption">
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h2 data-animation="animated fadeInUp">We implement your plan <br /> on time</h2>
                                <br><br>
                                <!-- <p data-animation="animated fadeInDown">An unknown printer took a galley of type and
                                    scrambled it <br /> to make a type specimen book.</p> -->
                                <a href="#about-us" class="banner-btn" data-animation="animated fadeInDown">About Us</a>
            ...
            <div class="item slide-3"
                style="background-image: url(img/caravasal3.jpg);background-position: right center;">

                <div class="carousel-caption">
                    <div class="container">
                        <div class="box valign-middle">
                            <div class="content text-left">
                                <h2 data-animation="animated fadeInUp">We Do Only What <br />We Are Great on</h2>
                                <br><br>
                                <!-- <p data-animation="animated fadeInDown">An unknown printer took a galley of type and
                                    scrambled it <br /> to make a type specimen book.</p> -->
                                <a href="#about-us" class="banner-btn" data-animation="animated fadeInDown">About Us</a>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="about-content">
                        ...
                        <br>
                        <p>Starnet offers a complete range of outsourced services to telecom operators and broadcasters.
                            Starnet supports network development through Network Planning, Site & Power Acquisition,
                            Site Infrastructure Development, System Installation and Commissioning. Additionally the
                            operation and maintenance of telecom networks as well as radio and television broadcasting
                            stations can be optimized through our Managed Services portfolio.</p>
                        <br><br>
                        <a href="#services" id="services" class="about-btn">Our Services</a>
                    </div><!-- /.about-content -->
                </div><!-- /.col-md-6 -->
                <div class="col-md-6 text-right">
                    <img src="img/about-img.jpg" alt="Awesome Image" />
                </div><!-- /.col-md-6 -->
            </div><!-- /.row -->
        </div><!-- /.container -->
         ...
         <div class="row"> 
             <div class="col-md-6"> 
                 <div class="cta-style-two-1"> 
                     ...
                     <h3>We do only what we are <br /> great on</h3> 
             ...
             <div class="col-md-6"> 
                 <div class="cta-style-two-2"> 
                     ...
                     <p>Perspiciatis unde omnis iste natus error sit voluptatem accusantium remque lau <br /> dantium, totam rem aperiam, eaque ipsa quae ab.</p> 
                     <a href="#" class="cta-btn">Our Work Process</a> 
                 </div>     
             </div>
        </div> 
     </div> 
            ...
            <div class="service-carousel-one owl-theme owl-carousel">
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service1.jpg" alt="Awesome Image" />
                        ...
                        <div class="content-box">
                            ...
                            <div class="text-box">
                                ...
                                <p>Access Network Designing, Installation & Commissioning</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                ...
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service2.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                ...
                                <p>Microwave Transmission Designing, Installation & Commissioning</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service3.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                ...
                                <p>Installation & Commissioning of Core Network</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service5.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                ...
                                <p>Optical Fiber Installation & Testing</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service6.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                ...
                                <p>Telecommunication Maintenance Service Contracts</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service7.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                <!-- <a href="#"><h3>House Remodel</h3></a> -->
                                <p>Network Infrastructure Surveys & Asset Verifications</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service8.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                <!-- <a href="#"><h3>Tower Construction</h3></a> -->
                                <p>Field Surveys and Drive Tests</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service9.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                <!-- <a href="#"><h3>Interior Design</h3></a> -->
                                <p>Cellular Site Acquisition Services</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service10.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                <!-- <a href="#"><h3>Interior Design</h3></a> -->
                                <p>Installation & Commissioning of Radio and Television Systems including IPTV</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
                <div class="item">
                    <div class="single-service-style-one">
                        <div class="img-box">
                            <img src="img/service11.jpg" alt="Awesome Image" />
                            <a href="#" class="read-more fas fa-link"></a>
                        </div><!-- /.img-box -->
                        <div class="content-box">
                            <div class="icon-box">
                            ...
                            <div class="text-box">
                                <!-- <a href="#"><h3>Interior Design</h3></a> -->
                                <p>Installation of CCTV Systems</p>
                            </div><!-- /.text-box -->
                        </div><!-- /.content-box -->
                    </div><!-- /.single-service-style-one -->
                </div><!-- /.item -->
    ...
    <div class="container">
        ...
        <div class="row masonary-layout filter-layout" data-filter-class="filter">
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction oil">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-1.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction mechanical">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-2.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="#" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction oil">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-3.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="#" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item mechanical oil">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-4.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="#" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item welding">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-5.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="#" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item mechanical">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-6.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="#" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-7.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="#" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item welding">
                <div class="single-project-style-two">
                    <div class="img-box">
                        <img src="img/project-2-8.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="#" class="more-btn fas fa-link"></a>
        ...
        <div class="more-btn-box text-center">
            <a href="#" class="thm-btn">All Projects</a>
        </div>
    </div>
</section> -->
    ...
    <div class="brand-carousel-wrapper">
        <div class="container">
            <div class="brand-carousel owl-carousel owl-theme">
                <div class="item">
                    <i class="brands-logo-icon"><img src="./img/airtel.jpeg" alt=""></i>
                </div><!-- /.item -->
                <div class="item">
                    <i class="brands-logo-icon"><img src="./img/etisalat.jpeg" alt=""></i>
                </div><!-- /.item -->
                <div class="item">
                    <i class="brands-logo-icon"><img src="./img/dialog.jpeg" alt=""></i>
                </div><!-- /.item -->
                <div class="item">
                    <i class="brands-logo-icon"><img src="./img/hutch.jpeg" alt=""></i>
                </div><!-- /.item -->
                <div class="item">
                    <i class="brands-logo-icon"><img src="./img/mobitel.jpeg" alt=""></i>
                </div><!-- /.item -->
            </div><!-- /.brand-carousel -->
        </div><!-- /.container -->
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-two">
                    ...
                    <div class="text-box">
                        ...
                        <a href="#"><h3>2018 Project: Planning Anduff  Construction</h3></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-two">
                    ...
                    <div class="text-box">
                        ...
                        <a href="#"><h3>Central Valley Comes Calling with Industrial Options</h3></a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-two">
                    ...
                    <div class="text-box">
                        ...
                        <a href="#"><h3>Columbus' Industrial Market Continues to Rise</h3></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="map-contact-info home-page-two" id="contact">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <!-- <div class="google-map" id="home-two-google-map" data-map-lat="40.712784" data-map-lng="-74.005941"
                        data-icon-path="img/map-marker-1.png" data-map-title="Brooklyn, New York, United Kingdom"
                        data-map-zoom="11" data-markers='{
                    ...
                    <div class="google-map" id="home-two-google-map" data-map-lat="6.877307" data-map-lng="79.903532"
                        data-icon-path="img/map-marker-1.png" data-map-title="Nugegoda, Sri Lanka" data-map-zoom="11"
                        data-markers='{
                    "marker-1": [6.877307, 79.903532, "<h4>Main Office</h4><p>52, Ekwatta Road, Nugegoda, Sri Lanka</p>"]
                }'></div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="single-contact-info">
                                    ...
                                    <p> Starnet Engineering Consultants (Pvt) Ltd, <br>
                                        52, Ekwatta Road, <br>
                            ...
                            <div class="col-md-6">
                                <div class="single-contact-info">
                                    ...
                                    <a href="tel:+94 11 4503 871">+94 70 3033 000</a>
                                </div><!-- /.single-contact-info -->
                                <div class="single-contact-info">
                                    <i class="zxp-icon-old-telephone-ringing"></i>
                                    <a href="tel:+94 11 4503 871">+94 11 4503 871</a>
                                </div><!-- /.single-contact-info -->
                                <div class="single-contact-info">
                                    <i class="fas fa-envelope-open"></i>
                                    <a href="mailto:info@starnet.lk">info@starnet.lk</a>
                                </div><!-- /.single-contact-info -->
    ...
    <footer class="site-footer">
                ...
                <div class="row ">
                    <div class="col-md-8 col-sm-6 col-xs-12">
                        <div class="footer-widget about-widget">
                            <a href="index.html"><img src="img/starnet-logo - footer.jpeg" alt="Awesome Image" /></a>
                            <p>
                                Starnet Engineering Consultants (Pvt) Limited was established in 2011 under the
                                Companies Act (No. 7 of 2007). Starnet is a leading provider of supporting services to
                                telecommunication industry in Sri Lanka. We offer a wide range of services, including
                                system integration, maintenance, surveys, fault rectification to telcos and broadcasters
                                as well.
                                <br>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget links-widget">
                            ...
                            <ul class="links-list">
                                <li><a id="destination" href="#home"><i class="fas fa-angle-right"></i>Home</a></li>
                                <li><a id="destination" href="#about-us"><i class="fas fa-angle-right"></i>About Us</a>
                                </li>
                                <li><a id="destination" href="#services"><i class="fas fa-angle-right"></i>Services</a>
                                </li>
                                <li><a id="destination" href="#contact"><i class="fas fa-angle-right"></i>Contact</a>
                                </li>
                            </ul><!-- /.links-list -->
                    ...
                    <!-- <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit. Ed quia -->
                    <!-- con sequuntur.</p> -->
                    ...
                    <!-- <div class="img-box"> -->
                    <!-- <img src="img/footer1.jpg" alt="Awesome Image" /> -->
                    <!-- </div> -->
                    <!-- /.img-box -->
                    <!-- <div class="text-box"> -->
                    <!-- <a href="#"> -->
                    <!-- <h4>China industrial profit growth slows to low</h4> -->
                    <!-- </a> -->
                    <!-- <p>5 hours ago</p> -->
                    <!-- </div> -->
                    <!-- /.text-box -->
                    ...
                    <!-- <div class="single-recent-post"> -->
                    <!-- <div class="img-box"> -->
                    <!-- <img src="img/footer2.jpg" alt="Awesome Image" /> -->
                    <!-- </div> -->
                    <!-- /.img-box -->
                    <!-- <div class="text-box"> -->
                    <!-- <a href="#"> -->
                    <!-- <h4>Industrial space to remain tight</h4> -->
                    <!-- </a> -->
                    <!-- <p>5 hours ago</p> -->
                    <!-- </div> -->
                    <!-- /.text-box -->
        ...
        <div class="container">
            ...
            <div class="right-form-box pull-right">
                <form action="inc/mailchimp/subscribe.php" class="footer-subscribe-form clearfix mailchimp-form">
        ...
        <div class="container">
            <div class="copy-text pull-left">
                <p>
                    ...
                    2018 &copy; All Rights Reserved by Starnet Engineering Consultants (Pvt) Ltd | Team Yogeemedia
                </p>
            </div><!-- /.copy-text -->
